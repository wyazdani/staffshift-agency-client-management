'use strict';
const {AgencyConsultantRoleRepository} = require('../src/AgencyConsultantRole/AgencyConsultantRoleRepository');
const {AgencyConsultantRoleCommandHandler} = require('../src/AgencyConsultantRole/AgencyConsultantRoleCommandHandler');
...
module.exports.addAgencyConsultantRole = async (req, res, next) => {
  ...
  let repository = new AgencyConsultantRoleRepository(EventStore);
  let handler = new AgencyConsultantRoleCommandHandler(repository);
