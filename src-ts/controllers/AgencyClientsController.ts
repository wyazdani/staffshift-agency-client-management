...
export class AgencyClientsController {
   ...
   */
  static async getAgencyClient(req: SwaggerRequest, res: ServerResponse, next: Function) {
   ...
   * @param next - The callback used to pass control to the next middleware
   */
  static async listAgencyClients(req: SwaggerRequest, res: ServerResponse, next: Function) {
    const swaggerParams = req.swagger.params || {};
    const logger = req.Logger;
