...
export class AgencyConsultantRoleController {
  /**
   ...
   */
  static async addAgencyConsultantRole(req: SwaggerRequest, res: ServerResponse, next: Function) {
   ...
   * @param next - The callback used to pass control to the next middleware
   */
  static async updateAgencyConsultantRole(req: SwaggerRequest, res: ServerResponse, next: Function) {
   ...
   * @param next - The callback used to pass control to the next middleware
   */
  static async changeStatusAgencyConsultantRole(req: SwaggerRequest, res: ServerResponse, next: Function) {
    const agencyId = get(req, 'swagger.params.agency_id.value', '');
    const consultantRoleId = get(req, 'swagger.params.consultant_role_id.value', '');
    const command_type = get(req, 'swagger.operation.x-octophant-event', '');
   ...
   * @param next - The callback used to pass control to the next middleware
   */
  static async getAgencyConsultantRole(req: SwaggerRequest, res: ServerResponse, next: Function) {
    const agencyId = get(req, 'swagger.params.agency_id.value', '');
    const consultantRoleId = get(req, 'swagger.params.consultant_role_id.value', '');
   ...
   * @param next - The callback used to pass control to the next middleware
   */
  static async listAgencyConsultantRoles(req: SwaggerRequest, res: ServerResponse, next: Function) {
    const agencyId = get(req, 'swagger.params.agency_id.value', '');
