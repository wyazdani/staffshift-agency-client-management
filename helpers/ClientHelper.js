...
module.exports = {
   ...
   */
  deserializeStatusCode400: function deserializeStatusCode400(client, model, response) {
   ...
   * @return {Object}
   */
  deserializeServerError: function deserializeServerError(client, error, model, response) {
    let item = client.deserialize(response, model);
   ...
   */
  resourceNotFoundError: function resourceNotFoundError(response) {
   ...
   */
  permissionDeniedError: function permissionDeniedError(response) {
