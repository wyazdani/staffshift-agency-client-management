...
import {CompleteApplyPaymentTermOrganisationJobCommandInterface} from '../types/CommandTypes';
...
export class CompleteApplyPaymentTermOrganisationJobCommandHandler implements OrganisationJobCommandHandlerInterface {
   ...
   */
  async execute(command: CompleteApplyPaymentTermOrganisationJobCommandInterface): Promise<void> {
