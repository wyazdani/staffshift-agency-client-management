...
import {
  ...
  FailItemConsultantJobAssignCommandDataInterface, CompleteConsultantJobAssignCommandDataInterface
    ...
    await this.repository.save([
      {
        ...
        data: commandData as CompleteConsultantJobAssignCommandDataInterface,
        sequence_id: ++eventId
      }
    ]);
  }
