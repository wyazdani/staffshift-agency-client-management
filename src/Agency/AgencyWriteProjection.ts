...
import {AgencyConsultantRoleEnum, AgencyEventEnum} from './AgencyEnums';
import {AgencyAggregateRecordInterface, AgencyConsultantRoleInterface, AgencyEventInterface} from './Interfaces';

type AgencyWriteProjectionType = {
  [key in AgencyEventEnum]: (aggregate: AgencyAggregateRecordInterface, event: AgencyEventInterface) =>
