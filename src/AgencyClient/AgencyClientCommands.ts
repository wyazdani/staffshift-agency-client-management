...
type AgencyClientCommandsType = {
  [key in AgencyClientCommandEnum]: (
    aggregate: AgencyClientAggregate,
    command: AgencyClientConsultantInterface
...
export const AgencyClientCommands: AgencyClientCommandsType = {
  ...
  [AgencyClientCommandEnum.LINK_AGENCY_CLIENT]: async (
    aggregate: AgencyClientAggregate,
    command: AgencyClientConsultantInterface
  ): Promise<AgencyClientEventInterface[]> => {
  ...
  // CMD coming from a Triage Domain Event
  [AgencyClientCommandEnum.UNLINK_AGENCY_CLIENT]: async (
    aggregate: AgencyClientAggregate,
    command: AgencyClientConsultantInterface
  ): Promise<AgencyClientEventInterface[]> => {
    const isLinked = aggregate.isLinked();
  ...
  // CMD coming from a Triage Domain Event
  [AgencyClientCommandEnum.SYNC_AGENCY_CLIENT]: async (
    aggregate: AgencyClientAggregate,
    command: AgencyClientConsultantInterface
  ): Promise<AgencyClientEventInterface[]> => {
  ...
  [AgencyClientCommandEnum.ADD_AGENCY_CLIENT_CONSULTANT]: async (
    aggregate: AgencyClientAggregate,
    command: AgencyClientConsultantInterface
  ): Promise<AgencyClientEventInterface[]> => {
  ...
  [AgencyClientCommandEnum.REMOVE_AGENCY_CLIENT_CONSULTANT]: async (
    aggregate: AgencyClientAggregate,
    command: AgencyClientConsultantInterface
  ): Promise<AgencyClientEventInterface[]> => {
    // Need to do a try catch here
