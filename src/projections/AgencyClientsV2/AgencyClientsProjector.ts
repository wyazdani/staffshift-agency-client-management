...
import {EventStorePubSubModelInterface, EventStoreListenerInterface} from 'ss-eventstore';
...
export default class AgencyClientsProjector implements EventStoreListenerInterface {
