 ...
 */
export class AgencyClientUnLinkedEventHandler
implements EventHandlerInterface<EventStoreModelInterface<AgencyClientUnlinkedEventStoreDataInterface>> {
  constructor(private logger: LoggerContext) {}

  /**
   * Create a new agency client consultant record
   */
  async handle(event: EventStoreModelInterface<AgencyClientUnlinkedEventStoreDataInterface>): Promise<void> {
