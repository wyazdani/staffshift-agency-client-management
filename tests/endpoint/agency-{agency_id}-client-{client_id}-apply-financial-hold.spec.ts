...
describe('agency-{agency_id}-client-{client_id}-apply-financial-hold', () => {
  ...
  describe('post', () => {
    ...
    it('should respond with 202 updates financial hold', async () => {
      ...
      const res = await api
        .post(`/agency/${agencyId}/client/${clientId}/apply-financial-hold`)
        .set(headers)
        .send(payload);
    ...
    it('should respond with 400 Validation Error', async () => {
      ...
      const res = await api.post(`/agency/${agencyId}/client/${clientId}/apply-financial-hold`).set(headers).send();
