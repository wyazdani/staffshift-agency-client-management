import {AgencyClientsProjection, AgencyClientsProjectionDocument} from '../../../src/models/AgencyClientsProjection';
import {get} from 'lodash';

export class AgencyClientsProjectionScenarios {
  static async createRecord(document: {[key in string]: string | boolean | Date}): Promise<AgencyClientsProjectionDocument> {
