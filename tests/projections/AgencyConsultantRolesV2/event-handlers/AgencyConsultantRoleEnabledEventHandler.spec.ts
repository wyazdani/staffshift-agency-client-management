...
describe('AgencyConsultantRoleEnabledEventHandler', () => {
  afterEach(() => {
    sinon.restore();
  });
  ...
  describe('handle()', () => {
    ...
    it('should enable status agency consultant role record', async () => {
      const handler = new AgencyConsultantRoleEnabledEventHandler(TestUtilsLogger.getLogger(sinon.spy()));
