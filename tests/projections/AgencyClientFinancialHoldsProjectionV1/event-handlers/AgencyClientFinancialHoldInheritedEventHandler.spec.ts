...
import {AgencyClientFinancialHoldInheritedEventHandler} from '../../../../src/projections/AgencyClientFinancialHoldsProjectionV1/event-handlers';
import {TestUtilsLogger} from '../../../tools/TestUtilsLogger';

describe('AgencyClientFinancialHoldInheritedEventHandler', () => {
  afterEach(() => {
    sinon.restore();
  });
  describe('handle()', () => {
    ...
    it('Test success scenario', async () => {
      ...
      const handler = new AgencyClientFinancialHoldInheritedEventHandler(logger, eventStoreCacheHelper);
