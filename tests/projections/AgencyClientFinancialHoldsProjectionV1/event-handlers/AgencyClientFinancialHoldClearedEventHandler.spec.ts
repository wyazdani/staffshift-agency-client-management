...
import {AgencyClientFinancialHoldClearedEventHandler} from '../../../../src/projections/AgencyClientFinancialHoldsProjectionV1/event-handlers';
import {TestUtilsLogger} from '../../../tools/TestUtilsLogger';

describe('AgencyClientFinancialHoldClearedEventHandler', () => {
  afterEach(() => {
    sinon.restore();
  });
  describe('handle()', () => {
    ...
    it('Test success scenario', async () => {
      ...
      const handler = new AgencyClientFinancialHoldClearedEventHandler(logger, eventStoreCacheHelper);
