...
import {AgencyClientRequiresUniquePONumberSetEventHandler} from '../../../../src/projections/AgencyClientBookingPreferencesProjectionV1/event-handlers';

describe('AgencyClientRequiresUniquePONumberSetEventHandler', () => {
  afterEach(() => {
    sinon.restore();
  });
  describe('handle()', () => {
    ...
    it('Test success scenario', async () => {
      ...
      const handler = new AgencyClientRequiresUniquePONumberSetEventHandler();
