...
import {CompleteInheritFinancialHoldCommandHandler} from '../../../../src/aggregates/OrganisationJob/command-handlers/CompleteInheritFinancialHoldCommandHandler';
...
import {CompleteInheritFinancialHoldCommandInterface} from '../../../../src/aggregates/OrganisationJob/types/CommandTypes';
import {EventsEnum} from '../../../../src/Events';

describe('CompleteInheritFinancialHoldCommandHandler class', () => {
  describe('execute()', () => {
    ...
    it('Test success scenario', async () => {
      ...
      aggregate.validateCompleteInheritFinancialHold.resolves();
      aggregate.getLastSequenceId.returns(1);
      repository.save.resolves();
      const handler = new CompleteInheritFinancialHoldCommandHandler(repository);

      await handler.execute(command);
      repository.getAggregate.should.have.been.calledOnceWith(command.aggregateId);
      aggregate.validateCompleteInheritFinancialHold.should.have.been.calledOnceWith(command.data);
